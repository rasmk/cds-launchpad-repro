		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "TS launchpad plugin",
									"targetURL": "#compacgcssptslaunchpadplugin-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"compacgcssptslaunchpadplugin-display": {
								"semanticObject": "compacgcssptslaunchpadplugin",
								"action": "display",
								"description": "TypeScript lauchpad plugin",
								"title": "TS launchpad plugin",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.pacg.cssp.tslaunchpadplugin",
									"url": sap.ui.require.toUrl("com/pacg/cssp/tslaunchpadplugin")
								}
							}
						}
					}
